 ...
 */
public class Cyclists_ring_WebViewActivity extends AppCompatActivity {
    WebView web;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cyclists_webview);
        init();
    ...
    private void init() {
        ...
        web.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Cyclists_ring_WebViewActivity.this);
        ...
        web.loadUrl("http://tingchexihuo.kuaizhan.com/");
  //      web.loadUrl(t);
